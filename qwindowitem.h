...
class QWindowItem : public QDeclarativeItem
{
    ...
    Q_PROPERTY(int geometryX READ geometryX NOTIFY xChanged)
    Q_PROPERTY(int geometryY READ geometryY NOTIFY yChanged)
    ...
    Q_PROPERTY(bool closeByUser READ closeByUser WRITE setCloseByUser NOTIFY closeByUserChanged)
...
public:
    ...
    int geometryX() const { return _window->geometry().x(); }
    int geometryY() const { return _window->geometry().y(); }
    ...
    Qt::WindowFlags windowFlags() const { return _window->windowFlags(); }
    QString title() const { return _window->windowTitle(); }
    bool deleteOnClose() const { return _deleteOnClose; }
    bool closeByUser() const { return _closeByUser; }
...
//    void setGeometry ( const QRect & );
    ...
    void setCloseByUser(bool close);
    void setWindowFlags(Qt::WindowFlags flags) {
        _window->setWindowFlags(flags);
    }

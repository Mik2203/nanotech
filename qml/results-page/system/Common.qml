...
//            width: _UNITS_WIDTH + _VALUE_WIDTH * 2
    ...
    Row {
        ...
        Column {
            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Temperature") }
            ...
            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Flow Factor") }
                TableRowUnits { units: "" }
                TableRowValue { value: sys.flowFactor }
            }

            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Power") }
                TableRowUnits { units: app.translator.emptyString + qsTr("kW") }
                TableRowValue { value: sys.power }
            }

            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Specific energy") }
                TableRowUnits { units: app.translator.emptyString + qsTr("kWh/m³") }
                TableRowValue { value: sys.specificEnergy }
            }

            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Active Area") }
            ...
            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Total elements count") }
                TableRowUnits { units: "" }
                TableRowValue { value: sys.elementsCount }
            }

            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Element lifetime") }
                TableRowUnits { units: app.translator.emptyString + qsTr("year(s)", "", sys.elementLifetime) }
                TableRowValue { value: sys.elementLifetime }
            }

            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Avg. Flux") }
            ...
            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Recovery") }
                TableRowUnits { units: "%" }
                TableRowValue { value: sys.recovery * 100.0 }
            }

            Row {
                TableRowTitle { width: 147; title: app.translator.emptyString + qsTr("Rejection") }
                TableRowUnits { units: "%" }
        ...
        Column {
            ...
            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Raw water flow") }
            ...
            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Stage 1 feed flow") }
                TableRowUnits { units: app.translator.emptyString + unitsText.flowUnitText(app.units.flowUnits) }
            ...
            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Feed TDS") }
                TableRowUnits { units: app.translator.emptyString + qsTr("mg/l") }
                TableRowValue { value: sys.feed.solutes.totalValueMgl }
            }

            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Feed pressure") }
            ...
            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Feed osmotic pressure") }
                TableRowUnits { units: app.translator.emptyString + unitsText.pressureUnitText(app.units.pressureUnits) }
            ...
            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Feed pH") }
                TableRowUnits { units: "" }
                TableRowValue { value: sys.feed.pH }
            }

            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Permeate flow") }
                TableRowUnits { units: app.translator.emptyString + unitsText.flowUnitText(app.units.flowUnits) }
                TableRowValue { value: app.units.convertFlowUnits(sys.permeate.rate, ROUnits.DEFAULT_FLOW_UNITS, app.units.flowUnits) }
            }

            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Permeate TDS") }
                TableRowUnits { units: app.translator.emptyString + qsTr("mg/l") }
                TableRowValue { value: sys.permeate.solutes.totalValueMgl }
            }

            Row {
                TableRowTitle { width: 168; title: app.translator.emptyString + qsTr("Permeate pressure") }
                TableRowUnits { units: app.translator.emptyString + unitsText.pressureUnitText(app.units.pressureUnits) }
